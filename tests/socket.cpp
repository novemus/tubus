...
BOOST_AUTO_TEST_SUITE(udp_socket)
...
BOOST_AUTO_TEST_CASE(ssl)
{
    ...
    boost::asio::ssl::stream<tubus::udp::socket> server(tubus::udp::socket(g_reactor.io, 1234567890), srv);
    ...
    boost::asio::ssl::stream<tubus::udp::socket> client(tubus::udp::socket(g_reactor.io, 1234567890), clt);
...
BOOST_AUTO_TEST_SUITE(tcp_socket)
...
BOOST_AUTO_TEST_CASE(ssl)
{
    ...
    boost::asio::ssl::stream<tubus::tcp::socket> server(tubus::tcp::socket(g_reactor.io, 1234567890), srv);
    ...
    boost::asio::ssl::stream<tubus::tcp::socket> client(tubus::tcp::socket(g_reactor.io, 1234567890), clt);
